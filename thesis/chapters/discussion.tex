...
% Brief recap of RQ1/RQ2/RQ3 findings.
...
\begin{itemize}
    \item \textbf{Causal verification of the absence hypothesis.} The geometric evidence from RQ1 is consistent with the absence hypothesis but does not causally verify it. Causal mediation analysis or targeted path patching could test whether the absence of the refusal direction causally explains LRL compliance.
